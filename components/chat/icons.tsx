...
export const PDFIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      clipRule="evenodd"
      d="M14.5 13.5V6.5V5.41421C14.5 5.149 14.3946 4.89464 14.2071 4.70711L9.79289 0.292893C9.60536 0.105357 9.351 0 9.08579 0H8H3H1.5V1.5V13.5C1.5 14.8807 2.61929 16 4 16H12C13.3807 16 14.5 14.8807 14.5 13.5ZM13 13.5V6.5H9.5H8V5V1.5H3V13.5C3 14.0523 3.44772 14.5 4 14.5H12C12.5523 14.5 13 14.0523 13 13.5ZM9.5 5V2.12132L12.3787 5H9.5ZM4.5 4V5H6.5V4H4.5ZM4.5 7V8H11.5V7H4.5ZM4.5 10V11H11.5V10H4.5Z"
      fill="currentColor"
      fillRule="evenodd"
    />
    <text
