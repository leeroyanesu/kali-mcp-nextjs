  ...
  return (
    <TooltipProvider delayDuration={0}>
      <motion.div
        ...
        className="absolute right-6 bottom-6 z-50 flex max-h-[80vh] cursor-pointer flex-col items-center overflow-y-auto overflow-x-hidden rounded-3xl border bg-background py-1 shadow-lg scrollbar-hide"
